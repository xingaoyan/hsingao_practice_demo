...
└── data/manifest/materials_manifest.jsonl
    data/manifest/materials_summary.json
    data/manifest/processing_queue.jsonl
    data/rejected/unsupported_files.jsonl
    data/extracted/8fde162be62c742f88df99a948b8b3a60d72533a61d4a9d6c602f0d25b285598/parsed.json
    data/extracted/8fde162be62c742f88df99a948b8b3a60d72533a61d4a9d6c602f0d25b285598/parse_report.json
...
```bash
# 创建项目目录
mkdir -p "$HOME/projects/system-architect-learning"
